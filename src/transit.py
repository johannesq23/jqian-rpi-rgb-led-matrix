...
class TransitClient:
  ...
  def get_transits(self, station_id=None, line=None):
    """
    Return trains filtered by station_id and/or line.
    """
    ...
    for train in trains:
      if station_id and train.get("station_id") != station_id:
        continue

      if line and train.get("line") != line:
        continue
